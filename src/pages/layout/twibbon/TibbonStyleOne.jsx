            ...
            <div className={`w-[400px] md:w-[800px] aspect-square overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
              ...
              {isCheckedTitle ? ( 
                <div className='absolute z-50'>
                  <img className='w-[400px] md:w-[800px] aspect-square' src='https://raw.githubusercontent.com/unaivan22/twibbonlebaran/refs/heads/master/public/twibbon/layer/1.webp' />
                </div>
              ) : null}

              {isCheckedTitle ? ( 
              <div className='absolute top-[68px] md:top-[160px] left-[20px] md:left-[60px] z-[999]'>
                ...
                <div className='berkshireswash text-[14.7px] md:text-[23.7px] leading-[22px] md:leading-[22px]  font-bold text-[#D5A431]'>
              ...
              {isCheckedTitle ? ( 
              <div className='absolute max-w-[40%] top-[68px] md:top-[160px] right-[20px] md:right-[60px] z-[999]'>
                <div className='text-[10px] md:text-[16px] leading-[18px] md:leading-[28px] font-light text-white text-right'>
