            ...
            <div className={`w-[400px] md:w-[800px] aspect-square overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
              ...
              {isCheckedTitle ? ( 
                <div className='absolute z-50'>
                  <img className='w-[400px] md:w-[800px] aspect-square' src='https://raw.githubusercontent.com/unaivan22/twibbonlebaran/refs/heads/master/public/twibbon/layer/4.webp' />
                </div>
              ) : null}

              {isCheckedTitle ? ( 
              <div className='absolute top-[68px] md:top-[160px] right-[12px] md:right-[60px] z-[999]'>
                <div className='flex flex-col items-end gap-2 md:gap-4 md:mb-2 '>
