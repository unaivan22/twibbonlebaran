            ...
            <div className={`w-[400px] md:w-[800px] aspect-square overflow-hidden relative shadow-2xl flex flex-col items-center justify-center bg-white renderthis` } ref={elementRef}>
              ...
              {isCheckedTitle ? ( 
                <div className='absolute z-50'>
                  <img className='w-[400px] md:w-[800px] aspect-square' src='https://raw.githubusercontent.com/unaivan22/twibbonlebaran/refs/heads/master/public/twibbon/layer/3.webp' />
                </div>
              ) : null}

              {isCheckedTitle ? ( 
              <div className='absolute bottom-[12px] md:bottom-[40px] z-[999]'>
                ...
                <div className='flex flex-col items-center'>
                  <div className='berkshireswash text-[14.7px] md:text-[23.7px] leading-[22px] md:leading-[22px] font-bold text-[#D5A431] text-center'>
                      <HtmlRenderer html={inputPersonPosition} />
                  </div>
                  <div className='max-w-[70%] md:max-w-[50%] text-[10px] md:text-[16px] leading-[18px] md:leading-[28px] font-light text-white text-center mt-1 md:mt-6'>
